# UI Sprite Source Map

This folder explains where the curated UI sprite copies came from.

## Rules

- raw source art remains under `Assets/Sprite`
...
- primary curated source: `Complete_UI_Book_Styles_Pack_Free_v1.0/01_TravelBookLite`
- audited but not curated: `Free - Raven Fantasy Icons`
